import { CashIcon, CreditCardIcon, SwitchHorizontalIcon, UserCircleIcon } from '@heroicons/react/outline'
...
const P2PFooter = () => {
  return (
    <div className="grid grid-cols-3 mt-20 place-items-center ">
                {/* Fiat currency user */}

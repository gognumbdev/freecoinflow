...
const GlobalOffer = ({crypto,spendCrypto,setSpendCrypto,receiveCrypto,setReceiveCrypto}) => 
{
    ...
    return (
        <div className='grid grid-cols-1 place-items-start shadow-xl border-2 rounded px-4 py-4'>
            <h1 className='text-2xl font-bold my-2 place-self-center'>Crypto-Crypto exchange offer</h1>
            ...
            <div className='grid grid-cols-1 px-10 lg:px-14 py-2 space-x-10 space-y-4 ml-10'>
                ...
                {/* Amount and Price */}
                  <div className='flex items-center justify-center space-x-14 '>
                        ...
                        <div className='w-fit'>
                            ...
                            {transactionType === "buy" ? (
                                `Amount of ${spendCrypto.name} need to spend`
                                ) : (
                                `Available ${spendCrypto.name} need to sales`
                            )}
                            </label>
                        ...
                        <div className='w-fit'>
                            <label htmlFor="price" className="block text-lg font-medium text-gray-700">
                                Price for 1 {receiveCrypto.code} 
                            </label>
                            <div className="mt-1 relative rounded-md shadow-sm border-2 flex p-2">
                                <input
                                type="number"

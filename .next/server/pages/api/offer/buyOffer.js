...
const { BuyOfferModel  } = __webpack_require__(5178);
async function handler(req, res) {
    // Connect to MongoDB dattabase
    _database_dbConnect__WEBPACK_IMPORTED_MODULE_1___default()();
    // get all of the data bbject
    const user = (0,react_redux__WEBPACK_IMPORTED_MODULE_0__.useSelector)((state)=>state.user
    );
...
var __webpack_exports__ = __webpack_require__.X(0, [873], () => (__webpack_exec__(6021)));
